...
public:
	...
	void SetEditPosX(float edit) { this->editPosX = edit; }
	void SetEditPosY(float edit) { this->editPosY = edit; }
...
private:
	...
	enum
	{
		...
		BUTTON_INPUT_STATUS_DOWN, //1
		BUTTON_INPUT_STATUS_UP,  //2
		BUTTON_INPUT_STATUS_PRESS,  //3
		BUTTON_INPUT_STATUS_DBLCLK  //4
	};
